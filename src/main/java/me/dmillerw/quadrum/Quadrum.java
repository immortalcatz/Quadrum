 ...
 * @author dmillerw
 */
@Mod(modid = ModInfo.MOD_ID, name = ModInfo.MOD_NAME, dependencies = "required-after:resourceloader", acceptedMinecraftVersions = "[1.11,1.12)", version = ModInfo.MOD_VERSION)
